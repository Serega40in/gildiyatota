                    ...
                    <div class="tl_page_wrap">
                        <div class="tl_page">
                            <main class="tl_article tl_article_editable">
                                ...
                                <article v-html="article.bodytext.substring(0,50)" id="_tl_editor" class="tl_article_content ql-container ql-disabled"></article>
                                <v-flex row wpar xs12 md12 sm12>
                                    <v-flex offset-5><v-img style="width: 100px" v-bind:src="article.imgUrl" alt="img"></v-img></v-flex>
                                    <v-spacer></v-spacer>
